...
export const REELS: ReelItem[] = [
  ...
  { id: 'ib-reel01', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: "You don't have to bloom on schedule. #Growth #SelfCompassion", music: 'Gentle Flow', audioKey: 'relaxing_water', videoKey: 'Reel01-Bloom',    hugs: 0, theme: { bg: '#fff8f6', blob1: '#ffdad2', blob2: '#b8e6e0', avatarBg: '#e8836b' } },
  { id: 'ib-reel02', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: 'Soft is not the opposite of strong. #Strength #Mindset',                  music: 'Gentle Flow', audioKey: 'relaxing_water', videoKey: 'Reel02-Contrast',  hugs: 0, theme: { bg: '#fff8f6', blob1: '#ffdad2', blob2: '#b8e6e0', avatarBg: '#e8836b' } },
  ...
  { id: 'ib-reel04', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: 'Feel it the size it actually is. #Emotions #Awareness',                   music: 'Gentle Flow', audioKey: 'relaxing_water', videoKey: 'Reel04-WordSize',  hugs: 0, theme: { bg: '#fff8f6', blob1: '#ffdad2', blob2: '#b8e6e0', avatarBg: '#e8836b' } },
  ...
  { id: 'ib-reel07', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: 'Healing is not linear. Neither is light. #Healing #Depression',            music: 'Tidal Pad', audioKey: 'ambient', videoKey: 'Reel07-Wave',     hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffe2db', avatarBg: '#55433e' } },
  { id: 'ib-reel08', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: 'Notice what you reach for when no one is watching. #SelfAwareness',        music: 'Gentle Flow', audioKey: 'relaxing_water', videoKey: 'Reel08-Spotlight', hugs: 0, theme: { bg: '#fff8f6', blob1: '#ffdad2', blob2: '#b8e6e0', avatarBg: '#e8836b' } },
  ...
  { id: 'ib-lf06', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: "You're not lazy. You're carrying something nobody can see. #Depression #MentalHealth",                 music: 'Tidal Pad', audioKey: 'ambient', videoKey: 'LF06-Depression-NotLazy',     hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffe2db', avatarBg: '#55433e' } },
  { id: 'ib-lf07', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: 'Depression is the absence of access to yourself — not sadness. #Depression',                           music: 'Tidal Pad', audioKey: 'ambient', videoKey: 'LF07-Depression-NotSadness',   hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffe2db', avatarBg: '#55433e' } },
  { id: 'ib-lf08', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: "You don't have to feel grateful to be healing. #Healing #Depression",                                  music: 'Tidal Pad', audioKey: 'ambient', videoKey: 'LF08-Depression-NotGrateful',  hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffe2db', avatarBg: '#55433e' } },
  { id: 'ib-lf09', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: 'Showering when you have no energy is an act of war against what tells you nothing matters. #Depression', music: 'Tidal Pad', audioKey: 'ambient', videoKey: 'LF09-Depression-Shower',      hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffe2db', avatarBg: '#55433e' } },
  { id: 'ib-lf10', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: 'Some people loved you tired. Get better anyway. #Depression #Healing',                                 music: 'Tidal Pad', audioKey: 'ambient', videoKey: 'LF10-Depression-LovedTired',   hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffe2db', avatarBg: '#55433e' } },
  ...
  { id: 'ib-lf21', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: "Your anxiety is not irrational — it's answering a question nobody is asking out loud. #Anxiety",               music: 'ASMR Still', audioKey: 'asmr_anxiety', videoKey: 'LF21-Anxiety-NotIrrational',  hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffdad2', avatarBg: '#994531' } },
  { id: 'ib-lf22', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: 'If you feel anxious around someone, your body knows something your brain is ignoring. Trust it. #Anxiety',       music: 'ASMR Still', audioKey: 'asmr_anxiety', videoKey: 'LF22-Anxiety-AroundSomeone',  hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffdad2', avatarBg: '#994531' } },
  { id: 'ib-lf23', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: "Stop trying to calm down. Start asking what you're not safe to feel. #Anxiety #NervousSystem",                  music: 'ASMR Still', audioKey: 'asmr_anxiety', videoKey: 'LF23-Anxiety-StopCalmDown',   hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffdad2', avatarBg: '#994531' } },
  { id: 'ib-lf24', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: "You don't have anxiety. You have a nervous system that learned love came with conditions. #Anxiety #Healing",    music: 'ASMR Still', audioKey: 'asmr_anxiety', videoKey: 'LF24-Anxiety-LoveCost',       hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffdad2', avatarBg: '#994531' } },
  { id: 'ib-lf25', quote: '', author: 'InnerBloom', handle: '@innerbloom', caption: "Overthinking is a survival skill from a time when getting it wrong was dangerous. You're safe now. #Anxiety",   music: 'ASMR Still', audioKey: 'asmr_anxiety', videoKey: 'LF25-Anxiety-Overthinking',   hugs: 0, theme: { bg: '#fff8f6', blob1: '#b8e6e0', blob2: '#ffdad2', avatarBg: '#994531' } },
